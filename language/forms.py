...
class AddPostForm(forms.ModelForm):
    ...
    def clean_title(self):
        ...
        if len(title) > 200:
            raise ValidationError('Длина более 200 символов')
...
class RegisterUserForm(UserCreationForm):
    ...
    password2 = forms.CharField(label='Введите пароль повторно', widget=forms.PasswordInput(attrs={'class': 'form-input'}))
